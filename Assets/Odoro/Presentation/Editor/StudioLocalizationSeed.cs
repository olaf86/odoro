namespace Odoro.Editor
{
    ...
    internal static class StudioLocalizationSeed
    {
        public static readonly StudioLocalizationSeedEntry[] Entries =
        {
            ...
            new("model-selection.subtitle", "Choose skeleton preview, a bundled humanoid prefab, or a prepared GCS model.", "スケルトンプレビュー、同梱 humanoid prefab、用意済みの GCS モデルを選択します。"),
            new("model-selection.selected", "Selected", "選択中"),
            new("model-selection.tap-to-use", "Tap to use this model", "タップしてこのモデルを使う"),
            new("model-selection.tap-to-download", "Tap to download", "タップしてダウンロード"),
            ...
            new("toast.avatar-loading", "Loading avatar model...", "アバターモデルを読み込み中です..."),
            new("toast.avatar-downloading", "Downloading avatar model: {0}", "アバターモデルをダウンロード中です: {0}"),
